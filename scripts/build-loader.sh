...
for name in \
  pmoslive-luton26.bin pmoslive-luton26.bin.sha256 pmoslive-luton26.descriptor.json \
  pmoslive-jaguar1.bin pmoslive-jaguar1.bin.sha256 pmoslive-jaguar1.descriptor.json; do
